    ...
    if finance_sheet is None:
        ...
        with expenses_tab:
            ...
            with st.form("add_txn_form", clear_on_submit=True):
                ...
                if st.form_submit_button("➕ חוללי תנועה", use_container_width=True):
        ...
        with standing_orders_tab:
            ...
            if finance_data.get("standing_orders", []):
                ...
                if st.session_state.get("delete_mode_so", False) == False:
                    so_df["בחרי"] = False
                    
                so_disp = so_df[["id", "בחרי"] if "בחרי" in so_df.columns else ["id"]].copy()
