...
from utils import update_inventory_for_order, save_inventory_to_sheet
        ...
        if not customer_data.empty:
            ...
            if not orders_df.empty:
                ...
                if not customer_orders.empty:
                    ...
                    cols = ["תשלום", "סטטוס", "צריכת בד 2", "בד 2", "צריכת בד", "בד", "התאמות", "גזרת תחתון", "גזרת עליון", "תחתון", "עליון", "מחיר", "פריט", "תאריך מסירה", "תאריך הזמנה", "מ\"ה"]
